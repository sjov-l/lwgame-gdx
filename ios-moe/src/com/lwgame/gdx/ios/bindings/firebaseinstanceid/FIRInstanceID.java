package com.lwgame.gdx.ios.bindings.firebaseinstanceid;
...
public class FIRInstanceID extends NSObject {
	...
	@Generated
	@Selector("instanceIDWithHandler:")
	public native void instanceIDWithHandler(
			@ObjCBlock(name = "call_instanceIDWithHandler") Block_instanceIDWithHandler handler);

	@Runtime(ObjCRuntime.class)
	@Generated
	public interface Block_instanceIDWithHandler {
		@Generated
		void call_instanceIDWithHandler(FIRInstanceIDResult arg0, NSError arg1);
	}
