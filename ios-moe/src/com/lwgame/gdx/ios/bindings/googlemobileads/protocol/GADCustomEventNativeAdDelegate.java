...
public interface GADCustomEventNativeAdDelegate {
	...
	@Generated
	@Selector("customEventNativeAd:didReceiveMediatedUnifiedNativeAd:")
	void customEventNativeAdDidReceiveMediatedUnifiedNativeAd(
			@Mapped(ObjCObjectMapper.class) Object customEventNativeAd,
			@Mapped(ObjCObjectMapper.class) Object mediatedUnifiedNativeAd);
}