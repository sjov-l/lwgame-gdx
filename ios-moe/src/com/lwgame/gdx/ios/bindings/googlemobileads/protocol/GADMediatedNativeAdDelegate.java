...
public interface GADMediatedNativeAdDelegate {
	...
	@Generated
	@IsOptional
	@Selector("mediatedNativeAd:didRenderInView:clickableAssetViews:nonclickableAssetViews:viewController:")
	default void mediatedNativeAdDidRenderInViewClickableAssetViewsNonclickableAssetViewsViewController(
			@Mapped(ObjCObjectMapper.class) Object mediatedNativeAd,
			UIView view,
